...
writer = SummaryWriter(log_dir='/home/pankaj/AML-Models/fusion_models/logs/concat')
...
class Activity_Detection(nn.Module):
    def __init__(self, resnet_size, c3d_size, audio_size, projected_size, hidden_size, num_classes):
        ...
        self.fc_out = nn.Linear(hidden_size*2*3, num_classes)
    ...
    def forward(self, resnet_features, c3d_features, audio_features):
        ...
        fused_out = torch.cat([audio_final, resnet_final, c3d_final], dim=1)
